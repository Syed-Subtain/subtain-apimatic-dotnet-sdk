    ...
    new CreateOrUpdateCoupon
    {
        Coupon = CreateOrUpdateCouponCoupon.FromCreateOrUpdatePercentageCoupon(
            new CreateOrUpdatePercentageCoupon
            {
                ...
                ProductFamilyId = "2",
                Stackable = "true",
                CompoundingStrategy = CreateOrUpdatePercentageCouponCompoundingStrategy.FromCompoundingStrategy(CompoundingStrategy.Compound),
