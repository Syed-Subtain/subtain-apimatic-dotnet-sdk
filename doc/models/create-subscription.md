...
| `ProductId` | `string` | Optional | The Product ID of the product for which you are creating a subscription. The product ID is not currently published, so we recommend using the API Handle instead. |
| `ProductPricePointHandle` | `string` | Optional | The user-friendly API handle of a product's particular price point. |
| `ProductPricePointId` | `string` | Optional | The ID of the particular price point on the product. |
...
| `Components` | [`List<CreateSubscriptionComponents>`](../../doc/models/containers/create-subscription-components.md) | Optional | This is List of a container for one-of cases. |
...
| `Group` | [`CreateSubscriptionGroup2`](../../doc/models/containers/create-subscription-group-2.md) | Optional | This is a container for one-of cases. |
...
| `ExpiresAt` | `string` | Optional | Timestamp giving the expiration date of this subscription (if any). You may manually change the expiration date at any point during a subscription period. |
...
| `PrepaidSubscriptionConfiguration` | [`UpsertPrepaidConfiguration`](../../doc/models/upsert-prepaid-configuration.md) | Optional | - |
