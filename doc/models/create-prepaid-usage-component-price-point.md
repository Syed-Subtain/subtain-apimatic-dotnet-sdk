...
| `ExpirationIntervalUnit` | [`CreatePrepaidUsageComponentPricePointExpirationIntervalUnit`](../../doc/models/containers/create-prepaid-usage-component-price-point-expiration-interval-unit.md) | Optional | This is a container for one-of cases. |
