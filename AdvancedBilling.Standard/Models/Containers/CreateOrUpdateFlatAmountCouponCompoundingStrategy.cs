// <copyright file="CreateOrUpdateFlatAmountCouponCompoundingStrategy.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CreateOrUpdateFlatAmountCouponCompoundingStrategy>),
        new Type[] {
    ...
    public abstract class CreateOrUpdateFlatAmountCouponCompoundingStrategy
    {
        ...
        /// </summary>
        /// <returns>
        /// The CreateOrUpdateFlatAmountCouponCompoundingStrategy instance, wrapping the provided CompoundingStrategy value.
        /// </returns>
        public static CreateOrUpdateFlatAmountCouponCompoundingStrategy FromCompoundingStrategy(CompoundingStrategy compoundingStrategy)
        {
        ...
        private sealed class CompoundingStrategyCase : CreateOrUpdateFlatAmountCouponCompoundingStrategy, ICaseValue<CompoundingStrategyCase, CompoundingStrategy>
        {
