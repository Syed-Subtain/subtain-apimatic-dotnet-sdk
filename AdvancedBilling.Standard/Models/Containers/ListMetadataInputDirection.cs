// <copyright file="ListMetadataInputDirection.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ListMetadataInputDirection>),
        new Type[] {
    ...
    public abstract class ListMetadataInputDirection
    {
        ...
        /// </summary>
        /// <returns>
        /// The ListMetadataInputDirection instance, wrapping the provided SortingDirection value.
        /// </returns>
        public static ListMetadataInputDirection FromSortingDirection(SortingDirection sortingDirection)
        {
        ...
        private sealed class SortingDirectionCase : ListMetadataInputDirection, ICaseValue<SortingDirectionCase, SortingDirection>
        {
