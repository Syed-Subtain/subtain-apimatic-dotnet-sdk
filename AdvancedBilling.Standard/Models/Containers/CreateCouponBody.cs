// <copyright file="CreateCouponBody.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CreateCouponBody>),
        new Type[] {
    ...
    public abstract class CreateCouponBody
    {
        ...
        /// </summary>
        /// <returns>
        /// The CreateCouponBody instance, wrapping the provided CreateOrUpdateCoupon value.
        /// </returns>
        public static CreateCouponBody FromCreateOrUpdateCoupon(CreateOrUpdateCoupon createOrUpdateCoupon)
        {
        ...
        private sealed class CreateOrUpdateCouponCase : CreateCouponBody, ICaseValue<CreateOrUpdateCouponCase, CreateOrUpdateCoupon>
        {
