// <copyright file="ProductIntervalUnit.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ProductIntervalUnit>),
        new Type[] {
    ...
    public abstract class ProductIntervalUnit
    {
        ...
        /// </summary>
        /// <returns>
        /// The ProductIntervalUnit instance, wrapping the provided IntervalUnit value.
        /// </returns>
        ...
        private sealed class IntervalUnitCase : ProductIntervalUnit, ICaseValue<IntervalUnitCase, IntervalUnit>
        {
