// <copyright file="ListCustomersInputDirection.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ListCustomersInputDirection>),
        new Type[] {
    ...
    public abstract class ListCustomersInputDirection
    {
        ...
        /// </summary>
        /// <returns>
        /// The ListCustomersInputDirection instance, wrapping the provided SortingDirection value.
        /// </returns>
        public static ListCustomersInputDirection FromSortingDirection(SortingDirection sortingDirection)
        {
        ...
        private sealed class SortingDirectionCase : ListCustomersInputDirection, ICaseValue<SortingDirectionCase, SortingDirection>
        {
