// <copyright file="PricePointExpirationIntervalUnit.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<PricePointExpirationIntervalUnit>),
        new Type[] {
    ...
    public abstract class PricePointExpirationIntervalUnit
    {
        ...
        /// </summary>
        /// <returns>
        /// The PricePointExpirationIntervalUnit instance, wrapping the provided IntervalUnit value.
        /// </returns>
        ...
        private sealed class IntervalUnitCase : PricePointExpirationIntervalUnit, ICaseValue<IntervalUnitCase, IntervalUnit>
        {
