// <copyright file="OnOffComponentPricingScheme.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<OnOffComponentPricingScheme>),
        new Type[] {
    ...
    public abstract class OnOffComponentPricingScheme
    {
        ...
        /// </summary>
        /// <returns>
        /// The OnOffComponentPricingScheme instance, wrapping the provided PricingScheme value.
        /// </returns>
        ...
        private sealed class PricingSchemeCase : OnOffComponentPricingScheme, ICaseValue<PricingSchemeCase, PricingScheme>
        {
