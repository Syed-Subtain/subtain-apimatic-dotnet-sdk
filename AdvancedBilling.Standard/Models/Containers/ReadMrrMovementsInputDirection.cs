// <copyright file="ReadMrrMovementsInputDirection.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ReadMrrMovementsInputDirection>),
        new Type[] {
    ...
    public abstract class ReadMrrMovementsInputDirection
    {
        ...
        /// </summary>
        /// <returns>
        /// The ReadMrrMovementsInputDirection instance, wrapping the provided SortingDirection value.
        /// </returns>
        public static ReadMrrMovementsInputDirection FromSortingDirection(SortingDirection sortingDirection)
        {
        ...
        private sealed class SortingDirectionCase : ReadMrrMovementsInputDirection, ICaseValue<SortingDirectionCase, SortingDirection>
        {
