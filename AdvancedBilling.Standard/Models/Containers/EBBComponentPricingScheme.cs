...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<EBBComponentPricingScheme>),
        new Type[] {
    ...
    public abstract class EBBComponentPricingScheme
    {
        ...
        /// </summary>
        /// <returns>
        /// The EBBComponentPricingScheme instance, wrapping the provided PricingScheme value.
        /// </returns>
        ...
        private sealed class PricingSchemeCase : EBBComponentPricingScheme, ICaseValue<PricingSchemeCase, PricingScheme>
        {
