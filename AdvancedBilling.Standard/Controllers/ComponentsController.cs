...
namespace AdvancedBilling.Standard.Controllers
{
    ...
    public class ComponentsController : BaseController
    {
        ...
        /// <param name="componentId">Required parameter: Either the Chargify id of the component or the handle for the component prefixed with `handle:`.</param>
        /// <returns>Returns the Models.ComponentResponse response from the API call.</returns>
        public Models.ComponentResponse ArchiveComponent(
                int productFamilyId,
                string componentId)
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.ComponentResponse response from the API call.</returns>
        public async Task<Models.ComponentResponse> ArchiveComponentAsync(
                int productFamilyId,
                string componentId,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.ComponentResponse>()
        ...
        public void UpdateDefaultPricePointForComponent(
                int componentId,
                int pricePointId)
            => CoreHelper.RunVoidTask(UpdateDefaultPricePointForComponentAsync(componentId, pricePointId));
        ...
        public async Task UpdateDefaultPricePointForComponentAsync(
                int componentId,
                int pricePointId,
                CancellationToken cancellationToken = default)
        ...
        public void UpdateComponent(
                string componentId,
                Models.UpdateComponentRequest body = null)
            => CoreHelper.RunVoidTask(UpdateComponentAsync(componentId, body));
